...
**Github:** https://github.com/UTSCCSCC01/finalprojectw22-it-s-not-a-bug-it-s-a-feature
...
## Notes
- It's good that you identified the goal in your product backlog but you should also be identifying the why/benefit in the format of "As a ____, I want _____ so that ____".
- Another potential competitor to look at would be Facebook Gaming as they both have streaming as well as the social media platform all in one place.
- It would also be good to include some info in your personas relating to your unique feature of wanting to stay connected with streamers within the same website/app rather than using external social media platforms.
- Your mockups should also include your unique feature where viewers or streamers can interact with the community when the stream ends.
