...
**Team Name:** its not a bug its a feature
...
Tracking on Jira Total Mark: 17 / 24
...
## Notes
- Not sure if you guys were moving user stories to the next sprint as no "user_stories.md" was found. (Instructions were on Piazza if you were planning on moving usr stories.)
- INBIF-10 and INBIF-25 has no branch assocaited to it, no push history either.
- When making branches, make sure the branch name is associated with the Jira story.